...
def setup_directories():
    ...
    print("Setting up plot directories")
     ...
     # Create directories for different stages of analysis
...
def generate_raw_data_plots(raw_train_df):
    ...
    # Plot histogram of the target variable distribution
...
def generate_cleaning_plots(raw_train_df):
    ...
    # Plot the effect of temperature column cleaning
...
def generate_final_results_plots(final_model, X_train, y_train):
    ...
    # Train an importance model to get feature importances
...
def objective(trial, X, y):
    ...
    # Define parameter search spaces for CatBoost and XGBoost
    cat_params = {
    ...
    ridge_alpha = trial.suggest_float('ridge_alpha', 0.5, 5.0)
     # Define a stacking regressor with CatBoost and XGBoost as base estimators and Ridge as final estimator
...
def run_tuning():
    ...
    # Load training data and target variable
...
def run_prediction_pipeline(generate_plots=False):
    ...
    print("Final Model Training and Prediction Pipelin")
